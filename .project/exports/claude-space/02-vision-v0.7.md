...
services:
  app:
    build: { context: .project, dockerfile: docker/app.Dockerfile }
    ports: ["3000:3000"]
    environment:
  ...
  api:
    build: { context: .project, dockerfile: docker/api.Dockerfile }
    ports: ["3333:3333"]
    environment:
  ...
  puppeteer:
    build: { context: .project, dockerfile: docker/puppeteer.Dockerfile }
    ports: ["3002:3002"]
