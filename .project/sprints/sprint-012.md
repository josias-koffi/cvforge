...
- [x] **[US-043]** Générer la carte partageable LinkedIn et le partage natif
  - Agent: `designer`
  - Workflow: `analyze-design-dev-review`
  - Acceptance criteria:
    - [x] Une carte visuelle partageable est générée
    - [x] Le lien de partage LinkedIn natif fonctionne
    - [x] Le rendu reste cohérent avec l'identité produit
