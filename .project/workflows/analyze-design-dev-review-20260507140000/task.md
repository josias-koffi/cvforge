...
Run ID: analyze-design-dev-review-20260507140000
...
- Existing page: `apps/app/app/candidatures/page.tsx` (Server Component)
- Status badge colors: `status-metadata.ts`
- Interview score: `application.interviewReports[last].overallScore`
- Table pagination client-side (all filters/sort/page interact)
