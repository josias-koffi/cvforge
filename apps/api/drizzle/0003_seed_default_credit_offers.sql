...
VALUES
  (
    ...
    '{"fr": ["Crédits sans date d''expiration", "Paiement unique et sécurisé via Stripe", "Toutes les fonctionnalités incluses", "TVA incluse"], "en": ["Credits never expire", "One-time secure payment via Stripe", "Every feature included", "VAT included"]}',
    550,
    999,
    false,
    10
