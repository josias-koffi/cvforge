...
VALUES
  (
    ...
    '{"fr": ["5 candidatures complètes (analyse, CV et lettre)", "Crédits sans date d''expiration", "Paiement unique, sans abonnement"], "en": ["5 complete applications (analysis, CV and letter)", "Credits never expire", "One-time payment, no subscription"]}',
    40,
    590,
    false,
    10
  ...
  (
    ...
    '{"fr": ["20 candidatures complètes (analyse, CV et lettre)", "Crédits sans date d''expiration", "Paiement unique, sans abonnement"], "en": ["20 complete applications (analysis, CV and letter)", "Credits never expire", "One-time payment, no subscription"]}',
    145,
    1490,
    true,
    20
  ...
  (
    ...
    '{"fr": ["50 candidatures complètes (analyse, CV et lettre)", "Crédits sans date d''expiration", "Paiement unique, sans abonnement"], "en": ["50 complete applications (analysis, CV and letter)", "Credits never expire", "One-time payment, no subscription"]}',
    355,
    2900,
    false,
    30
